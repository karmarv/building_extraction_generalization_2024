...
def collate_fn(batch):
    images, bboxes, masks, images_path = zip(*batch)
    images = torch.stack(images)
    return images, bboxes, masks, images_path
...
class ResizeAndPad:
    ...
    def __call__(self, image, masks, bboxes, images_path):
        ...
        return image, masks, bboxes, images_path
